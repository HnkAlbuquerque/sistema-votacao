 ...
 * @endcode
 */
$settings['hash_salt'] = 'bHJq6s5GOlVhjDTipGkhZ8km_9MIa5YQQSnEa74voRucgmfALmEqJH7RQWYLY-eNJtUZg8q9LQ';
...
$settings['config_sync_directory'] = 'sites/default/files/config_Z0e8f5TavoMhOJtSThWmHI_BsTtuU9hFpqlEaxMW8Zgo2smfFhl99nYK3dJR57sM0txuKToQLg/sync';

/**
 * Diretório de sincronização de configuração, versionado no repositório.
 */
$settings['config_sync_directory'] = '../config/sync';

/**
 * Sobrescritas locais opcionais (não versionadas).
 */
if (file_exists($app_root . '/' . $site_path . '/settings.local.php')) {
  include $app_root . '/' . $site_path . '/settings.local.php';
}
